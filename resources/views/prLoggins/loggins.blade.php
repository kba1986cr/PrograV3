...
{{-- <x-app-layout meta-title="Calendario de Turnos" meta-description="Gestión de turnos">
    <div class="mx-auto mt-4 max-w-6xl">
...
{{-- <x-app-layout meta-title="Calendario" meta-description="Gestión de turnos">
    <div class="mx-auto mt-4 max-w-6xl">
        <h1 class="my-4 text-3xl text-center text-sky-600">Calendario</h1>

        <div class="flex">
            <div class="w-3/5 px-4">
                <div id="calendario" class="border p-4 rounded"></div>

                <div id="detalle-dia" class="hidden mt-4 p-4 border rounded">
                    <h3 id="dia-seleccionado">Día Seleccionado:</h3>
                    <select id="turno-select"></select>
            ...
            <div class="w-2/5 px-4">
                <div id="month-scroll" class="overflow-y-auto max-h-64"></div>
            </div>
        </div>
    </div>
</x-app-layout> --}}
...
{{-- <x-app-layout meta-title="Loggin title" meta-description="Loggin description">
    <div class="mx-auto mt-4 max-w-6xl">
        <h1 class="my-4 font-serif text-3xl text-center text-sky-600 dark:text-sky-500">Calendario</h1>
        <div class="main-content">
            <div class="left-section">
    ...
    <div class="mx-auto mt-4 max-w-6xl">
        ...
        <div class="main-content flex">
            ...
            <div class="left-section w-3/5 px-4">
                ...
                <section class="retractable-section mt-4">
                    <div class="detalle-dia p-4 border rounded shadow-md hidden" id="detalle-dia">
                        ...
                        <div class="time-controls flex items-center gap-4 mb-2">
                            <div class="flex flex-col items-center">
                                <label for="hora-inicio" class="text-sm font-medium mb-1">Hora de Inicio:</label>
                                <input id="hora-inicio" type="time" class="hora-inicio border rounded p-2">
                            </div>
                            <div class="flex flex-col items-center">
                                <label for="hora-fin" class="text-sm font-medium mb-1">Hora de Fin:</label>
                                <input id="hora-fin" type="time" class="hora-fin border rounded p-2">
                            </div>
                        </div>
            ...
            <div class="right-section w-2/5 px-4">
                <!-- Scroll de Meses -->
                <div class="div border p-4 rounded shadow-md">
                    <div class="month-scroll overflow-y-auto max-h-64" id="month-scroll">
                        <!-- Aquí se muestra la lista de meses -->
                    </div>
                </div>
